...
import {Answer, Choice, GithubChoiceValue, UniversalChoiceValue} from '../models/choice';

export async function fullCycleWithAutoQuestion(): Promise<Answer> {

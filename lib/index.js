...
var main = function () { return tslib_1.__awaiter(void 0, void 0, void 0, function () {
    var initializationLogic, configuration, _a, user_name, user_password, user_email, jenkins_host, routeAnswer, answer, jenkinsClient;
    return tslib_1.__generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 1:
                _a = _b.sent(), user_name = _a.user_name, user_password = _a.user_password, user_email = _a.user_email, jenkins_host = _a.jenkins_host;
                configuration = initialization_logic_1.create({
                    name: user_name,
